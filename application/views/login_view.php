                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Halaman Login Kasir XYZ</h3></div>
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="register.html" style="text-decoration:none">Aplikasi Kasir Berbasis Web</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
